...
import { Database, FileDown, Users, TrendingUp, Settings, LogOut, Shield } from 'lucide-react';
...
type AdminView = 'seeder' | 'docs' | 'legal' | 'investors' | 'beta' | 'revenue' | 'email' | 'tokens';
