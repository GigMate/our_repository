        ...
        <div className="bg-white rounded-lg shadow-2xl p-8">
          ...
          {Object.entries(categories).map(([key, category]) => {
            ...
            const colorClasses = {
              ...
              blue: { bg: 'bg-gray-800', border: 'border-blue-600', text: 'text-blue-900', hover: 'hover:bg-gray-700', button: 'bg-blue-600 hover:bg-blue-700' },
              yellow: { bg: 'bg-rose-50', border: 'border-yellow-600', text: 'text-yellow-900', hover: 'hover:bg-rose-100', button: 'bg-yellow-600 hover:bg-yellow-700' }
          ...
          <div className="bg-gray-800 border border-blue-600 rounded-lg p-6 mb-6">
